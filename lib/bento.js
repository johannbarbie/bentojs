...
const lendingPair_1 = __importDefault(require("./lendingPair"));
...
class Bento {
    ...
    getPair(assetA, assetB) {
        ...
        const lendingPairAddr = this.lendingPairs.get(key);
        return new lendingPair_1.default(this.provider, lendingPairAddr);
    }
